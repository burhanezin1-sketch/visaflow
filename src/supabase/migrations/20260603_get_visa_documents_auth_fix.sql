-- ============================================================
-- 20260603_get_visa_documents_auth_fix.sql
--
-- 1. DROP: SETOF imzalı eski fonksiyonu kaldır
-- 2. CREATE: RETURNS void + auth.uid() NULL kontrolü düzeltmesi
--    auth.uid() NULL ise kontrolü atla — RLS zaten korur
-- ============================================================
