-- ============================================================
-- 20260602_resmi_vize_postinsert_delete.sql
--
-- Resmi Vize için INSERT sonrası kesin temizlik:
-- Tüm katmanlar eklendikten SONRA, DEDUP'tan ÖNCE çalışır.
-- ILIKE ile banka/sigorta evraklarını siler — WHERE filter
-- yerine garantili post-insert yaklaşımı.
-- ============================================================
...
BEGIN
  ...
  -- ══════════════════════════════════════════════════════════
  -- Resmi Vize için banka ve sigorta evraklarını sil
  -- (INSERT sonrası garantili temizlik — isim varyantlarını yakalar)
  -- ══════════════════════════════════════════════════════════
