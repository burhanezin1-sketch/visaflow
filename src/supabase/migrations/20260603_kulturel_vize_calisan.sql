-- ============================================================
-- 20260603_kulturel_vize_calisan.sql
--
-- 1. visa_package_rules: Kültürel Vize + calisan → 'calisan' paketi
--    NULL kural priority 1 → 2
-- 2. get_visa_documents(): Kültürel Vize + calisan için
--    post-insert sponsor temizliği + global duplicate sigorta temizliği
-- ============================================================


-- ── 1. visa_package_rules ─────────────────────────────────────
INSERT INTO public.visa_package_rules
  (visa_type, occupation, package_name, priority, is_active)
VALUES
  ('Kültürel Vize', 'calisan', 'calisan', 1, true)
