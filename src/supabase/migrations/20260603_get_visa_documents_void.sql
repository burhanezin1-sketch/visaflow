-- ============================================================
-- 20260603_get_visa_documents_void.sql
--
-- RETURNS SETOF user_submitted_docs → RETURNS void
-- RETURN QUERY satırı kaldırıldı
-- Fonksiyon sadece INSERT/DELETE yapar, döndürmez.
-- Çağıranlar user_submitted_docs'tan ayrıca SELECT yapar.
-- ============================================================
