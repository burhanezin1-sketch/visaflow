-- ============================================================
-- 20260603_get_visa_documents_ctid_dedup.sql
--
-- MIN(id) / id DESC UUID sorununu düzelt:
-- Tüm duplicate temizleme adımları ctid tabanlı yaklaşıma geçirildi.
--   a.ctid > b.ctid → daha sonra eklenen (a) silinir, ilk eklenen kalır
-- Hem sigorta ILIKE dedup'u hem de DEDUP bloğu güncellendi.
-- ============================================================
