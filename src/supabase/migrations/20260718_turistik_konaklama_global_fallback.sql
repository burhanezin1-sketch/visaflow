-- Kural 54: Turistik vize global fallback — Amerika hariç tüm ülkelerde konaklama rezervasyonu garantile
...
BEGIN
  ...
  -- 54. Turistik global fallback: Amerika haric tum ulkelerde konaklama rezervasyonu garantile (DEDUP sonrasi)
