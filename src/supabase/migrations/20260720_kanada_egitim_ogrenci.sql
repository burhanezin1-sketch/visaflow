-- Kural 55: Kanada + Eğitim/Öğrenci + ogrenci: finansal evrak enjeksiyonu + akademik belge İngilizce notu (DEDUP sonrası)
...
BEGIN
  ...
  -- 54. Turistik global fallback: Amerika haric tum ulkelerde ucak + konaklama garantile (DEDUP sonrasi)
  IF p_visa_type = 'Turistik' AND p_country != 'Amerika Birleşik Devletleri' THEN
    INSERT INTO public.user_submitted_docs (application_id, doc_name, delivery_type, status)
