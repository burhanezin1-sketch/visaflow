-- ============================================================
-- 20260603_almanya_sicil_override_func.sql
--
-- 1. country_specific_docs: Almanya overrides (idempotent)
-- 2. get_visa_documents(): KATMAN 2'ye Almanya filtresi eklendi —
--    occupation paketindeki "...tercümeli%" ticaret sicil gazetesi
--    Almanya seçilince atlanır; country_specific_docs override gelir
-- ============================================================
...
BEGIN
  ...
  THEN
    ...
    WHERE  occupation = v_package
      ...
      -- Almanya: occupation paketindeki tercümeli ticaret sicil gazetesini atla
      -- country_specific_docs'taki tercümesiz override (order_num=103) gelir
      AND NOT (
        p_country = 'Almanya'
