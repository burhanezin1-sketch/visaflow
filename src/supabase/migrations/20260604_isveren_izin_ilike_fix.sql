-- Kural 4 ILIKE duzeltmesi: '%işveren izin%' → '%İşveren İzin%' (buyuk I)
...
BEGIN
  ...
  -- 5. Almanya: banka dokumu adini duzelt
  ...
  -- 6. Italya: banka dokumu adini duzelt
  ...
  -- 7. Fransa: ozel dilekce varsa genel dilekceyi sil
  ...
  -- 8. İngiltere: banka adını düzelt ve sigorta sil
  ...
  -- 9. Japonya: sigorta sil ve banka adını düzelt
  ...
  -- 10. Güney Kore: sigorta sil ve banka adını düzelt
  ...
  -- 11. Kanada: sigorta sil + ucak rezervasyonu sil + banka adı düzelt
  ...
  -- 12. Amerika Birlesik Devletleri ozel kurallari
