-- ============================================================
-- 20260602_japonya_tedavi_vizesi.sql
--
-- 1. country_specific_docs: Japonya + Tedavi/Sağlık Vizesi
--    temizle (boş zaten) ve doğru evrakları ekle
-- 2. get_visa_documents(): jp_tedavi_excl CONSTANT array ile
--    tüm 3 katmandan istenmeyen evrakları at
-- ============================================================


-- ── 1. country_specific_docs ──────────────────────────────────
DELETE FROM public.country_specific_docs
WHERE  country   = 'Japonya'
  AND  visa_type = 'Tedavi/Sağlık Vizesi';

INSERT INTO public.country_specific_docs
  (country, visa_type, doc_name, delivery_type, order_num)
VALUES
  ('Japonya', 'Tedavi/Sağlık Vizesi', 'Japonya Vize Başvuru Formu (fotoğraflı ve imzalı — konsolosluktan temin)',          'firma',   1),
  ('Japonya', 'Tedavi/Sağlık Vizesi', 'Japonyadaki kayıtlı kurumdan Tıbbi Kurum Garantör Belgesi (Guarantee of Medical Institution)', 'digital', 2),
  ('Japonya', 'Tedavi/Sağlık Vizesi', 'Türk doktordan sevk mektubu (İngilizce veya Japonca tercümeli)',                     'digital', 3),
  ('Japonya', 'Tedavi/Sağlık Vizesi', 'Tahmini tedavi maliyet belgesi (hastaneden)',                                         'digital', 4),
  ('Japonya', 'Tedavi/Sağlık Vizesi', 'Gidiş-dönüş uçak bileti rezervasyonu',                                               'digital', 5),
  ('Japonya', 'Tedavi/Sağlık Vizesi', 'Hastane konaklama belgesi veya otel rezervasyonu',                                   'digital', 6);


-- ── 2. get_visa_documents() güncelleme ───────────────────────
