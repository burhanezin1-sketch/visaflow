-- Kural 24: ikametgah tercüme UPDATE — ILIKE kalıpları yerine ~* regex operatörü
-- ~* büyük/küçük harf + aksan duyarsız; 'kamet' hem İkametgah hem ıkametgah yakalar
-- n.f.s deseni nüfus / nufus / nıfus gibi varyantları yakalar
-- NOT ILIKE '%çeviri%' filtresi eklendi
