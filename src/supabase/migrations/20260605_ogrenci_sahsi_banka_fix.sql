-- Ogrenci sahsi banka temizligi: LOWER() ile daha guclu eslesme
...
BEGIN
  ...
  IF p_occupation = 'ogrenci' THEN
    ...
    DELETE FROM public.user_submitted_docs
    WHERE  application_id = p_application_id
      AND  LOWER(doc_name) LIKE '%şahsi%'
      AND  LOWER(doc_name) LIKE '%banka%';
  ...
  -- 6. Schengen disi ulkelerde calisan: isveren izin yazisi adini duzelt
  ...
  -- 7. Almanya: banka dokumu adini duzelt
  ...
  -- 8. Italya: banka dokumu adini duzelt
  ...
  -- 9. Fransa: ozel dilekce varsa genel dilekceyi sil
  ...
  -- 10. İngiltere: banka adını düzelt ve sigorta sil
  ...
  -- 11. Japonya: sigorta sil ve banka adını düzelt
  ...
  -- 12. Güney Kore: sigorta sil ve banka adını düzelt
  ...
  -- 13. Kanada: sigorta sil + ucak rezervasyonu sil + banka adı düzelt
  ...
  -- 14. Amerika Birlesik Devletleri ozel kurallari
