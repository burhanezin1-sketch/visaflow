-- ============================================================
-- 20260603_almanya_banka_docname_fix.sql
--
-- POST-PROCESSING: Almanya için banka dökümü adını düzelt
-- "...İmza Sirküleri..." ibareli genel banka satırını
-- Almanya'ya özel kısa adla değiştir
-- ============================================================
...
BEGIN
  ...
  -- 4. Almanya: banka dökümü adını düzelt
  --    Genel standarttaki uzun ad → Almanya'ya özel kısa ad
  ...
  -- 5. Amerika Birleşik Devletleri özel kuralları
  IF p_country = 'Amerika Birleşik Devletleri' THEN

    -- 5a. Schengen, 30.000 € ve Ulusal (D Tipi) evrakları sil
    DELETE FROM public.user_submitted_docs
    WHERE  application_id = p_application_id
      AND (
    ...
    -- 5b. Biyometrik fotoğrafı Amerika standardına çevir (50x50 mm)
    UPDATE public.user_submitted_docs
