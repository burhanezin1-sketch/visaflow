-- ============================================================
-- 20260603_global_sirket_dedup.sql
--
-- Şirket evrakı mükerrerlik temizliği global yapıldı:
-- - Amerika bloğundan çıkarıldı
-- - p_occupation IN ('sirket_sahibi','serbest_meslek') koşuluyla
--   tüm ülkeler için POST-PROCESSING'e eklendi
-- ============================================================
...
BEGIN
  ...
  -- 3. GLOBAL: sirket_sahibi/serbest_meslek için tekil şirket evrakları temizliği
  --    Birleşik paket varsa tekil evraklar mükerrer olur — sil
  ...
  -- 4. Amerika Birleşik Devletleri özel kuralları
  IF p_country = 'Amerika Birleşik Devletleri' THEN

    -- 4a. Schengen, 30.000 € ve Ulusal (D Tipi) evrakları sil
    DELETE FROM public.user_submitted_docs
    WHERE  application_id = p_application_id
      AND (
    ...
    -- 4b. Biyometrik fotoğrafı Amerika standardına çevir (50x50 mm)
