-- Kural 35: Transit Vize — SGK/bordro/şirket evraklarını tamamen sil
-- Kural 36: Almanya + Transit Vize — Almanca tercüme ibaresi (SGK INSERT kaldırıldı, 35 zaten siler)
