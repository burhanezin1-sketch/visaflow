      ...
      <div style={{ padding: isMobile ? '0.75rem' : '1.5rem', overflowY: 'auto', flex: 1, background: '#e4eaf5' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: isMobile ? '8px' : '12px', marginBottom: hasForeign ? '0.5rem' : isMobile ? '0.75rem' : '1.5rem' }}>
          {[
            ...
            <div key={i} style={{ background: 'white', border: '1px solid rgba(188,204,226,0.45)', borderTop: '4px solid #3b82f6', borderRadius: isMobile ? '12px' : '14px', boxShadow: '0 4px 16px rgba(15,23,42,0.07)', padding: isMobile ? '0.75rem' : '1.25rem' }}>
        ...
        <div style={{ background: 'white', border: '1px solid rgba(188,204,226,0.45)', borderRadius: '14px', overflow: 'hidden', boxShadow: '0 4px 16px rgba(15,23,42,0.07)', marginBottom: isMobile ? '0.75rem' : '1.25rem' }}>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', minWidth: '560px' }}>
              ...
              <tbody>
                {bekleyenler.map(p => {
                  ...
                  return (
                    <tr key={p.id}>
                      <td style={{ padding: '10px 1.25rem', fontSize: '13px', fontWeight: '500', borderBottom: '1px solid rgba(188,204,226,0.3)' }}>{musteri?.full_name || '-'}</td>
                      <td style={{ padding: '10px 1.25rem', fontSize: '12px', color: '#5a6a7a', borderBottom: '1px solid rgba(188,204,226,0.3)' }}>{musteri?.users?.full_name || '-'}</td>
                      <td style={{ padding: '10px 1.25rem', fontSize: '12px', borderBottom: '1px solid rgba(188,204,226,0.3)' }}>{p.applications?.country} {p.applications?.visa_type}</td>
                      <td style={{ padding: '10px 1.25rem', fontSize: '13px', borderBottom: '1px solid rgba(188,204,226,0.3)' }}>{p.total_amount.toLocaleString('tr-TR')}{sym}</td>
                      <td style={{ padding: '10px 1.25rem', fontSize: '13px', color: '#1a7a45', borderBottom: '1px solid rgba(188,204,226,0.3)' }}>{p.paid_amount.toLocaleString('tr-TR')}{sym}</td>
                      <td style={{ padding: '10px 1.25rem', fontSize: '13px', color: '#c0392b', fontWeight: '600', borderBottom: '1px solid rgba(188,204,226,0.3)' }}>{kalan.toLocaleString('tr-TR')}{sym}</td>
                      <td style={{ padding: '10px 1.25rem', borderBottom: '1px solid rgba(188,204,226,0.3)' }}>
        ...
        <div style={{ background: 'white', border: '1px solid rgba(188,204,226,0.45)', borderRadius: '12px', overflow: 'hidden' }}>
          <div style={{ padding: isMobile ? '0.625rem 0.875rem' : '1rem 1.25rem', borderBottom: '1px solid rgba(188,204,226,0.3)' }}>
