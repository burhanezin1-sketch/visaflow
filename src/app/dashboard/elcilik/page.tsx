...
const schengen = [
  ...
  { ulke: '🇭🇺 Macaristan',  kurum: 'AS Visa',        url: 'https://www.askvisacenters.com/hungary' },
  { ulke: '🇨🇭 İsviçre',     kurum: 'TLScontact',     url: 'https://tr.tlscontact.com/visa/CH/TRIstanbul/' },
...
const araclar = [
  ...
  { ulke: '🇭🇺 AS Visa',                  kurum: 'Macaristan Vize Merkezi',    url: 'https://www.askvisacenters.com/hungary' },
  { ulke: '🇨🇭 TLScontact',              kurum: 'İsviçre Vize Merkezi',       url: 'https://tr.tlscontact.com/visa/CH/TRIstanbul/' },
